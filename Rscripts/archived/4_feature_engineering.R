...
table(train$Product_Info_7); table(test$Product_Info_7) # Categorical - 3 <====================== !! 2
...
table(train$Employment_Info_2); table(test$Employment_Info_2) # Categorical - 38 <====================== !! 17,22,25,28,29,30,31,33,35,38
...
table(train$InsuredInfo_3); table(test$InsuredInfo_3) # Categorical - 11 <====================== !! 5,7
...
table(train$Insurance_History_2); table(test$Insurance_History_2) # Categorical - 3 <====================== !! 2
table(train$Insurance_History_3); table(test$Insurance_History_3) # Categorical - 3 <====================== !! 2
...
table(train$Medical_History_3); table(test$Medical_History_3) # Categorical - 3 <====================== !! 1
table(train$Medical_History_4); table(test$Medical_History_4) # Categorical - 2
table(train$Medical_History_5); table(test$Medical_History_5) # Categorical - 3 <====================== !! 3
table(train$Medical_History_6); table(test$Medical_History_6) # Categorical - 3 <====================== !! 2
...
table(train$Medical_History_9); table(test$Medical_History_9) # Categorical - 3 <====================== !! 3
...
table(train$Medical_History_12); table(test$Medical_History_12) # Categorical - 3 <====================== !! 1
...
table(train$Medical_History_16); table(test$Medical_History_16) # Categorical - 3 <====================== !! 2
table(train$Medical_History_17); table(test$Medical_History_17) # Categorical - 3 <====================== !! 1
...
table(train$Medical_History_23); table(test$Medical_History_23) # Categorical - 3 <====================== !! 2
...
table(train$Medical_History_31); table(test$Medical_History_31) # Categorical - 3 <====================== !! 2
...
table(train$Medical_History_37); table(test$Medical_History_37) # Categorical - 3 <====================== !! 3
...
table(train$Medical_History_41); table(test$Medical_History_41) # Categorical - 3 <====================== !! 2
