...
META_XGB_MULSOFT <- as.data.frame(rbind(matrix(pred_a_softprob, ncol=8), matrix(pred_b_softprob, ncol=8)))
names(META_XGB_MULSOFT) <- paste('META_XGB_MUL_', 1:8, sep = '')
META_XGB_MULSOFT_MLOG <- as.data.frame(rbind(matrix(pred_a_softprob_mlog, ncol=8), matrix(pred_b_softprob_mlog, ncol=8)))
...
META_XGB_MULSOFT <- as.data.frame(matrix(pred_test_softprob, ncol=8))
names(META_XGB_MULSOFT) <- paste('META_XGB_MUL_', 1:8, sep = '')
META_XGB_MULSOFT_MLOG <- as.data.frame(matrix(pred_test_softprob_mlog, ncol=8))
names(META_XGB_MULSOFT_MLOG) <- paste('META_XGB_MUL_MLOG_', 1:8, sep = '')
...
META_XGB_MULSOFT <- as.data.frame(matrix(pred_a_softprob, ncol=8))
names(META_XGB_MULSOFT) <- paste('META_XGB_MUL_', 1:8, sep = '')
META_XGB_MULSOFT_MLOG <- as.data.frame(matrix(pred_a_softprob_mlog, ncol=8))
names(META_XGB_MULSOFT_MLOG) <- paste('META_XGB_MUL_MLOG_', 1:8, sep = '')
...
META_XGB_MULSOFT <- as.data.frame(matrix(pred_b_softprob, ncol=8))
names(META_XGB_MULSOFT) <- paste('META_XGB_MUL_', 1:8, sep = '')
META_XGB_MULSOFT_MLOG <- as.data.frame(matrix(pred_b_softprob_mlog, ncol=8))
names(META_XGB_MULSOFT_MLOG) <- paste('META_XGB_MUL_MLOG_', 1:8, sep = '')
