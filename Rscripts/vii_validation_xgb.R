...
testPreds <- test_rmse#(test_kap + test_rmse)/2
...
evalerror_2(preds = PredsOptim, labels = validation$Response)
# 0.6594426(a+b), 0.6552077(a), 0.6543481(b), 0.6559883(rmse), 0.6614489(kappa)
